...
class ControlsControllerTest < ActionController::TestCase
  ...
  test "should create control" do
    assert_difference('Control.count') do
      post :create, control: { description: @control.description, h: @control.h, lat: @control.lat, lng: @control.lng, name: @control.name, track_id: @control.track_id }
    end
  ...
  test "should update control" do
    patch :update, id: @control, control: { description: @control.description, h: @control.h, lat: @control.lat, lng: @control.lng, name: @control.name, track_id: @control.track_id }
    assert_redirected_to control_path(assigns(:control))
  end
